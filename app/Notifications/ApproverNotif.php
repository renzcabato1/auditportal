...
class ApproverNotif extends Notification
{
    ...
    public function __construct($total_for_approval,$request_for_action_plan,$return_action_plans,$actionplans_for_verification,$total_dues,$total_not_dues,$new_action_plan,$closed_action_plans)
    {
        //
        ...
        $this->total_for_approval = $total_for_approval;
    }
    ...
    public function toMail($notifiable)
    {
        ...
        ->line('    - Action Plans for Approval : '.$this->total_for_approval)
